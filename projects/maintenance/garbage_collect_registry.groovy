freeStyleJob('maintenance_garbage_collect_registry') {
    ...
    steps {
        ...
        shell('docker run --rm --disable-content-trust=false --name clean-registry -v /var/jenkins_home/.gsutil:/root/.gsutil -v /var/jenkins_home/.gcloud:/root/.config/gcloud -v /var/jenkins_home/.docker:/root/.docker:ro r.j3ss.co/clean-registry')
