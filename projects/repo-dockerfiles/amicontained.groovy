freeStyleJob('amicontained') {
    ...
    properties {
        ...
        sidebarLinks {
            ...
            link('https://hub.docker.com/r/jessfraz/amicontained', 'Docker Hub: jessfraz/amicontained', 'notepad.png')
    ...
    steps {
        ...
        shell('docker tag r.j3ss.co/amicontained:latest jessfraz/amicontained:latest')
        ...
        shell('docker push --disable-content-trust=false jessfraz/amicontained:latest')
        shell('for tag in $(git tag); do git checkout $tag; docker build  --rm --force-rm -t r.j3ss.co/amicontained:$tag . || true; docker push --disable-content-trust=false r.j3ss.co/amicontained:$tag || true; docker tag r.j3ss.co/amicontained:$tag jess/amicontained:$tag || true; docker push --disable-content-trust=false jess/amicontained:$tag || true; done')
