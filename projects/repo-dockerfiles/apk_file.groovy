freeStyleJob('apk_file') {
    ...
    steps {
        ...
        shell('for tag in $(git tag); do git checkout $tag; docker build  --rm --force-rm -t r.j3ss.co/apk-file:$tag . || true; docker push --disable-content-trust=false r.j3ss.co/apk-file:$tag || true; docker tag r.j3ss.co/apk-file:$tag jess/apk-file:$tag || true; docker push --disable-content-trust=false jess/apk-file:$tag || true; done')
