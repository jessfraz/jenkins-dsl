freeStyleJob('audit') {
    ...
    steps {
        ...
        shell('for tag in $(git tag); do git checkout $tag; docker build  --rm --force-rm -t r.j3ss.co/audit:$tag . || true; docker push --disable-content-trust=false r.j3ss.co/audit:$tag || true; docker tag r.j3ss.co/audit:$tag jess/audit:$tag || true; docker push --disable-content-trust=false jess/audit:$tag || true; done')
