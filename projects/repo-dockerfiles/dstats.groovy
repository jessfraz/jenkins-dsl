freeStyleJob('dstats') {
    ...
    steps {
        ...
        shell('docker build --rm --force-rm -t r.j3ss.co/dstats:${BRANCH} .')
        shell('docker tag r.j3ss.co/dstats:${BRANCH} jess/dstats:${BRANCH}')
        shell('docker push --disable-content-trust=false r.j3ss.co/dstats:${BRANCH}')
        shell('docker push --disable-content-trust=false jess/dstats:${BRANCH}')
