...
branches('*/master', '*/tags/*')
    ...
    steps {
        ...
        shell('docker build --rm --force-rm -t r.j3ss.co/onion:${BRANCH} .')
        shell('docker tag r.j3ss.co/onion:${BRANCH} jess/onion:${BRANCH}')
        shell('docker push --disable-content-trust=false r.j3ss.co/onion:${BRANCH}')
        shell('docker push --disable-content-trust=false jess/onion:${BRANCH}')
