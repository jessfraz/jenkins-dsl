freeStyleJob('pony') {
    ...
    steps {
        ...
        shell('for tag in $(git tag); do git checkout $tag; docker build  --rm --force-rm -t r.j3ss.co/pony:$tag . || true; docker push --disable-content-trust=false r.j3ss.co/pony:$tag || true; docker tag r.j3ss.co/pony:$tag jess/pony:$tag || true; docker push --disable-content-trust=false jess/pony:$tag || true; done')
