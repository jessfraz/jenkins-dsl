freeStyleJob('reg') {
    ...
    steps {
        ...
        shell('docker tag r.j3ss.co/reg:${BRANCH} jess/reg:$(cat .branch)')
        ...
        shell('docker tag r.j3ss.co/reg-server:${BRANCH} jess/reg-server:$(cat .branch)')
        shell('docker tag r.j3ss.co/reg-server:${BRANCH} jessfraz/reg-server:$(cat .branch)')
